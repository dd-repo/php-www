...
$content = "
		...
		<div class=\"content\">		
			...
			<div class=\"right big\">
				...
				<img class=\"doc\" src=\"/{$GLOBALS['CONFIG']['SITE']}/images/doc/37.png\" alt=\"37\" />
				<p>{$lang['create_text2']}</p>
				<img class=\"doc\" src=\"/{$GLOBALS['CONFIG']['SITE']}/images/doc/36.png\" alt=\"36\" />
				<p>{$lang['create_text3']}</p>
				<blockquote style=\"width: 700px; margin: 0 auto;\">
					<p>
						<span style=\"font-weight: bold;\">{$lang['sftp']}</span> sftp://phpworker-xxxxxx@ftp.anotherservice.com/master<br />
						<span style=\"font-weight: bold;\">{$lang['git']}</span> ssh://phpworker-xxxxxx@git.as/~utilisateur/phpworker-xxxxxxx.git
					</p>
				</blockquote>
...
\$msg = '".htmlspecialchars("<html><head><title>Hello, World!</title></head><body>Hello, World!</body></html>")."';
